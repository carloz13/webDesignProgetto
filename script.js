...
document.addEventListener('DOMContentLoaded', function () {
    ...
    window.onresize = function () {
        ...
        if((window.innerHeight/window.innerWidth)>2) document.getElementById('home_scritta').style.transform = 'translateY(-20vh)';
...
function createFramesBanner(insiemeFramesBanner) {
    for (var i = 2; i < numFrames; i++)
        insiemeFramesBanner.innerHTML += "<div class='frameBanner'><img draggable='false' src='images/framesBanner/frame-" + i + ".png' alt='Parte dello sfondo per la storia della rondine'></div>";
}
...
function allTextsBanner() {
    return [
        ...
        "E cos<span class='charSpecial'>ì</span> termina il viaggio di Rondine. <br>Il suo spirito avventuroso continuerà a ispirare <br>tutti coloro che amano esplorare il mondo."
    ];
}

function allTextsChildrens() {
    return [
        "Le rondini possono volare dall\'Africa all\'Europa senza problemi, ma per noi umani attraversare i confini pu<span class='charSpecial'>ò</span> essere molto pi<span class='charSpecial'>ù</span> complicato.<br><br> Le rondini possono volare lontano senza bisogno di permessi o documenti. Attraverso tanti paesi diversi e nessuno le ferma. <br><br>Per noi umani, viaggiare da un paese all<span class='charSpecial'>’</span>altro richiede spesso documenti speciali chiamati <span class='charSpecial'>“</span>visti<span class='charSpecial'>“</span> e dobbiamo passare attraverso controlli ai confini. <br><br>Alcuni bambini e adulti provenienti da molti paesi del mondo non possono spostarsi liberamente come le rondini perché ci sono delle regole diverse per ogni paese.",
...
function addCredits() {
    ...
    frames[20].insertAdjacentHTML("beforeend", `
        <div id='containerFinale'>
            ...
            <a class='linkImages' id='saveTheChildrenLinkImg' href='https://www.savethechildren.it'>
