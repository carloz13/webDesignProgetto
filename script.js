...
function addCredits() {
    let frames = insiemeFramesBambini.querySelectorAll('.frameBambini');
    frames[20].insertAdjacentHTML("beforeend", `
        <div id='containerFinale'>
            <p class='testoFinale'>
				Noi possiamo fare la nostra parte per aiutare questi bambini e famiglie nel loro viaggio.<br><br>
				Donando a <a class='linkText' href='https://www.savethechildren.it'>Save the Children</a>,
				possiamo contribuire a rendere il mondo un posto migliore e pi<span class='charSpecial'>ù</span> sicuro per tutti.</p>
            ...
            <div id='crediti'>
                ...
                <p class='testoFinale testoCrediti'>
					Basato sul racconto "Se fossimo come la rondine" Di Federico Celia, Federica Miccoli, Ilaria Pagano,<br>Zhiyi Wang
				</p>
                <h2>Ideato da:</h2>
                <p class='testoFinale testoCrediti'>
                ...
                <h2>Designers:</h2>
                <p class='testoFinale testoCrediti'>
					Federico Celia, Federica Miccoli, Ilaria Pagano,<br>Zhiyi Wang
				</p>
                <h2>Developers:</h2>
                <p class='testoFinale testoCrediti'>
